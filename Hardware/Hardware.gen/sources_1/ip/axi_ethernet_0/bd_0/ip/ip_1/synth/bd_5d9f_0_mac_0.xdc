...
set_max_delay -from [get_cells {bd_5d9f_0_mac_0_core/flow/rx_pause/pause*to_tx_reg[*]}] -to [get_cells {bd_5d9f_0_mac_0_core/flow/tx_pause/count_set*reg}] 32 -datapath_only
set_max_delay -from [get_cells {bd_5d9f_0_mac_0_core/flow/rx_pause/pause*to_tx_reg[*]}] -to [get_cells {bd_5d9f_0_mac_0_core/flow/tx_pause/pause_count*reg[*]}] 32 -datapath_only
set_max_delay -from [get_cells {bd_5d9f_0_mac_0_core/flow/rx_pause/pause_req_to_tx_int_reg}] -to [get_cells {bd_5d9f_0_mac_0_core/flow/tx_pause/sync_good_rx/data_sync_reg0}] 6 -datapath_only
...
set_max_delay -from [get_cells {vector_decode_inst/inc_vector_reg[*]}] -to [get_cells {bd_5d9f_0_mac_0_core/*statistics_counters/general_statisic_control[*].general_statisics/sync_inc_vector/data_sync_reg0}] 6 -datapath_only
set_max_delay -from [get_cells {vector_decode_inst/inc_vector_reg[*]}] -to [get_cells {bd_5d9f_0_mac_0_core/*statistics_counters/frame_size_bin_control1[*].frame_size_stats1/sync_inc_vector/data_sync_reg0}] 6 -datapath_only
set_max_delay -from [get_cells {vector_decode_inst/inc_vector_reg[*]}] -to [get_cells {bd_5d9f_0_mac_0_core/*statistics_counters/frame_size_bin_control2[*].frame_size_stats2/sync_inc_vector/data_sync_reg0}] 6 -datapath_only
set_max_delay -from [get_cells {bd_5d9f_0_mac_0_core/*statistics_counters/*/accumulator_gray_reg[*]}] -to [get_cells {bd_5d9f_0_mac_0_core/*statistics_counters/*/accum_gray_resync[*].sync_accum_gray_i/data_sync_reg0}] 6 -datapath_only
