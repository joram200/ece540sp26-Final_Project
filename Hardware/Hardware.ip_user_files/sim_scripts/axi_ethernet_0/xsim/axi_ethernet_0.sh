...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L axi_ethernet_buffer_v2_0_26 -L xbip_utils_v3_0_15 -L mult_gen_v12_0_24 -L tri_mode_ethernet_mac_v9_0_39 -L c_reg_fd_v12_0_11 -L c_shift_ram_v12_0_20 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_11 -L c_addsub_v12_0_21 -L c_counter_binary_v12_0_22 -L util_vector_logic_v2_0_5 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_ethernet_0 xil_defaultlib.axi_ethernet_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_ethernet_0 -key {Behavioral:sim_1:Functional:axi_ethernet_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5d9f_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_ethernet_0.wdb xsim.dir libdpi.so)
