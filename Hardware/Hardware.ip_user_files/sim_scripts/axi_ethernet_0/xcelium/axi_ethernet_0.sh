...
#
# Script generated by Vivado on Sat Jun 06 15:22:55 PDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_ethernet_0.sh
...
#
# Usage        : axi_ethernet_0.sh
#                axi_ethernet_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_ethernet_0.sh [-rerun]
#                axi_ethernet_0.sh [-reset_run]
#                axi_ethernet_0.sh [-clean]
#                axi_ethernet_0.sh [-reset_log]
#                axi_ethernet_0.sh [-help]
#
...
#                script (type 'axi_ethernet_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axi_lite_ipif_v3_0_4 -libname axi_ethernet_buffer_v2_0_26 -libname xil_defaultlib -libname xbip_utils_v3_0_15 -libname mult_gen_v12_0_24 -libname tri_mode_ethernet_mac_v9_0_39 -libname c_reg_fd_v12_0_11 -libname c_shift_ram_v12_0_20 -libname xbip_dsp48_wrapper_v3_0_7 -libname xbip_pipe_v3_0_11 -libname c_addsub_v12_0_21 -libname c_counter_binary_v12_0_22 -libname util_vector_logic_v2_0_5 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axi_lite_ipif_v3_0_4 axi_ethernet_buffer_v2_0_26 xil_defaultlib xbip_utils_v3_0_15 mult_gen_v12_0_24 tri_mode_ethernet_mac_v9_0_39 c_reg_fd_v12_0_11 c_shift_ram_v12_0_20 xbip_dsp48_wrapper_v3_0_7 xbip_pipe_v3_0_11 c_addsub_v12_0_21 c_counter_binary_v12_0_22 util_vector_logic_v2_0_5)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_ethernet_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_ethernet_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work tri_mode_ethernet_mac_v9_0_39 $xmvlog_opts +incdir+"../../../../../../../../../../../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work util_vector_logic_v2_0_5 $xmvlog_opts +incdir+"../../../../../../../../../../../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_ethernet_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_ethernet_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/run/media/sackb/Windows-SSD/Users/sackb/OneDrive/Desktop/University/Course_Work/2025-2026/Spring_2026/ECE_540/ece540sp26-Final_Project/Hardware/Hardware.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_ethernet_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_ethernet_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_ethernet_0.sh [-help]\n\
Usage: axi_ethernet_0.sh [-step]\n\
Usage: axi_ethernet_0.sh [-lib_map_path]\n\
Usage: axi_ethernet_0.sh [-rerun]\n\
Usage: axi_ethernet_0.sh [-reset_run]\n\
Usage: axi_ethernet_0.sh [-clean]\n\
Usage: axi_ethernet_0.sh [-reset_log]\n\
Usage: axi_ethernet_0.sh [-keep_index]\n\
Usage: axi_ethernet_0.sh [-noclean_files]\n\n\
