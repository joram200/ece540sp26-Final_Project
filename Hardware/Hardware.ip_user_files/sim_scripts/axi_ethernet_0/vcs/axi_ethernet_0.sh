...
design_libs=(xpm axi_lite_ipif_v3_0_4 axi_ethernet_buffer_v2_0_26 xil_defaultlib xbip_utils_v3_0_15 mult_gen_v12_0_24 tri_mode_ethernet_mac_v9_0_39 c_reg_fd_v12_0_11 c_shift_ram_v12_0_20 xbip_dsp48_wrapper_v3_0_7 xbip_pipe_v3_0_11 c_addsub_v12_0_21 c_counter_binary_v12_0_22 util_vector_logic_v2_0_5)
...
compile()
{
  ...
  vlogan -work tri_mode_ethernet_mac_v9_0_39 $vlogan_opts +v2k +incdir+"../../../../../../../../../../../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
  ...
  vlogan -work util_vector_logic_v2_0_5 $vlogan_opts +v2k +incdir+"../../../../../../../../../../../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_ethernet_0 xil_defaultlib.glbl -o axi_ethernet_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_ethernet_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/run/media/sackb/Windows-SSD/Users/sackb/OneDrive/Desktop/University/Course_Work/2025-2026/Spring_2026/ECE_540/ece540sp26-Final_Project/Hardware/Hardware.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key axi_ethernet_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_ethernet_0_simv.daidir vcs_lib c.obj)
