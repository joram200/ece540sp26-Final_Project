...
set genomeRtd $env(RT_TMP)/5C1F6040.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {veerwolf_core__GCB1}]"
...
set genomeName [subst -nocommands -novariables {veerwolf_core__GCB1}]
